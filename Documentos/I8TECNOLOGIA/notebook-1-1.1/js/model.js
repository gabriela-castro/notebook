...
request.onupgradeneeded = function (event) { 
    ...
    if (!db.objectStoreNames.contains("memos")) {
        ...
        sampleMemo1.title = "Bem vindo ao Notebook";
        sampleMemo1.content = "Esse e um aplicativo de notas. Use o icone de + no canto superior da pagina principal para adicionar uma nova nota ao seu caderno. Clique sobre a nota para editar. Tudo e salvo na hora.";
